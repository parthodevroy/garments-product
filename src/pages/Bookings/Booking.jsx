...
const Bookings = () => {
  ...
  console.log("hellow bokking",user);
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg shadow-md mt-10 rounded-lg">
      <h2 className="text-2xl font-bold mb-4">Booking: {product.product_name}</h2>

      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        <input type="email" readOnly value={user?.email} className="input bg" {...register("email")} />
        <input type="text" readOnly value={product.product_name} className="input bg" {...register("productName")} />
        <input type="number" readOnly value={product.price_usd} className="input bg" {...register("unitPrice")} />
        ...
        <input type="number" readOnly className="input bg" {...register("orderPrice")} />
